...
model.add_joint(m, 2, [20*12, 0.0])
model.add_joint(m, 3, [35*12, 0.0])
model.add_joint(m, 4, [50*12, 0.0])
model.add_joint(m, 5, [70*12, 0.0])
...
model.add_support(m["joints"][5], freedoms.U1)
model.add_support(m["joints"][5], freedoms.U2)
model.add_support(m["joints"][5], freedoms.UR3)
...
I1 = 300 # in^2
I2  = 1.25*I1
A1 =  71.1378660898# in^2
A2 = 76.6309432394 # in^2 
s1 = section.beam_2d_section("section_1", E, A1, I1)
s2 = section.beam_2d_section("section_1", E, A2, I2)


model.add_beam_member(m, 1, [1, 2], s2)
model.add_beam_member(m, 2, [2, 3], s1)
model.add_beam_member(m, 3, [3, 4], s1)
model.add_beam_member(m, 4, [4, 5], s2)

model.add_load(m["joints"][2], freedoms.U2, -50)
model.add_load(m["joints"][4], freedoms.U2, -50)
